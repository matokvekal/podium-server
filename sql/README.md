...
| `045-rider-stats-cache-columns.sql` | adds `rider_stats_cache.country` / `total_hours` for databases whose table came from an earlier draft of 035 (prod). ⚠ already applied on prod — never re-run | yes — additive |
